...
export class LRParserSimulator {
  ...
  public parse(scanner: BasicScanner, root: TreeNode<string>): TreeNode<string> {
    //throws SemanticError, SyntacticError, SyntacticError, LexicalError
  ...
  private step(): boolean {
    //throws SyntacticError, SemanticError, LexicalError
    ...
    switch (cmd.getType()) {
      ...
      case Command.ERROR:
        throw new SyntacticError(
          'Era esperado: ' + this.errors.get(state),
